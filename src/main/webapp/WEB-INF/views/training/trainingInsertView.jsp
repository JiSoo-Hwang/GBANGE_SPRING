...
<body>
	...
	<div class="board_wrap">
		...
		<form action="/gbangeSpring/insert.tr" method="post" id="training-area"
			enctype="multipart/form-data">
			<input type="hidden" name="trainingWriter" value="${loginUser.memberNo}">
			<div class="board_write_wrap">
				<div class="board_write">
					<div class="title">
						<dl>
							<dd>
								<input type="text" placeholder="훈련명을 입력해주세요." name="trainingTitle" required> 
